...
class SAC(object):
    def __init__(self, num_inputs, action_space):
        ...
        if torch.cuda.is_available():
            ...
            print('GPU available. Using device:', torch.cuda.get_device_name(0))
        else:
        ...
        if self.policy_type == "Gaussian":
            ...
            #print("Automation tuning- True", self.automatic_entropy_tuning)
            #if self.automatic_entropy_tuning is True:
            #print("Automation tuning- True")
    ...
    def load_checkpoint(self, ckpt_path="checkpoints", evaluate=False):
